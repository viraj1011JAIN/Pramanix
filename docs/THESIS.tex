...
\textbf{Test suite state} (Python~3.13.7, pytest~8.4.2): \textbf{4,021 passed},
164 skipped, 0 failed.  Branch coverage: \textbf{98.26\,\%} (98\,\% gate:
passing).  Baseline: commit~\code{081310c}, 2026-05-19 (18-issue sprint).
...
4,021 tests (sprint baseline) & \fname{reality.md}            & \cfrsec{3.1} \\
