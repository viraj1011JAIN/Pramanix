...
\textbf{Test suite state} (Python~3.13.7, pytest~7.4.4): \textbf{3,925 passed},
120 skipped, 0 failed.  Branch coverage: \textbf{98.26\,\%} (98\,\% gate:
passing).
...
3,925 tests (Phase~2)       & \fname{reality.md}            & \cfrsec{3.1} \\
